    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EventsListActivity.this,MainActivity.class));
            }
        });
        ...
        list=(ListView)findViewById(R.id.evtlist);
        s= new LocalStorage(this);
        events = new ArrayList<Event>();
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new RequestServer().execute(getString(R.string.server_ip_address)+"/displayevent");
            }
        });
    }
    @Override
    ...
    private class RequestServer extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s){
            try {
                ...
                EventView adapter = new EventView(EventsListActivity.this,R.layout.activity_events_adapter,events);
